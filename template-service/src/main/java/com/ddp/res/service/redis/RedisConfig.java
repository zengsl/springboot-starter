...
import static com.ddp.res.common.utils.JacksonUtil.*;
...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    @Bean
    public RedisTemplate<Object, Object> redisTemplate(RedisConnectionFactory connectionFactory, @Qualifier("keySerializer") RedisSerializer<String> keySerializer, @Qualifier("valueSerializer") RedisSerializer<?> valueSerializer) {
